...
import { ATTACKS_SCREEN, BASIC_INFO_SCREEN, CLASS_SPECIFIC_SCREEN, ITEMS_NAVIGATOR, ITEMS_SCREEN, SKILLS_SCREEN, SPELLS_NAVIGATOR, SPELLS_SCREEN } from '../common/constants/routeNames'
